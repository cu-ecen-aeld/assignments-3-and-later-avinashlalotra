...
void test_validate_my_username()
{
     ...
     */
    const char  *username_hard_coded = my_username();
    const char *username_in_file = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_hard_coded,username_in_file,"NULL");
